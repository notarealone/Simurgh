...
- Provides the retriever backbone that was directly adopted in the RAG framework ([retrieval-augmented-generation-for-knowledge-intensive-nlp-tasks](retrieval-augmented-generation-for-knowledge-intensive-nlp-tasks.md)).
