...
- Evaluated in English on PersonaBench; Persian-specific expansion must handle ZWNJ / ye-ke normalization so expanded terms actually match the index (cf. [[methodology]]).
