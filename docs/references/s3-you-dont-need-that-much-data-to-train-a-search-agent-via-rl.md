...
- Same lead author as [deepretrieval-hacking-real-search-engines-and-retrievers-with-large-language-models-via-reinforcement-learning](deepretrieval-hacking-real-search-engines-and-retrievers-with-large-language-models-via-reinforcement-learning.md) — read the two together for the "train the search side, freeze the reader" design pattern.
